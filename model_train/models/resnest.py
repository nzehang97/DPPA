...
def resnest18(pretrained=False, root='~/.encoding/models', num_classes=1000, **kwargs):
...
@RESNEST_MODELS_REGISTRY.register()
def resnest50(pretrained=False, root='~/.encoding/models', num_classes=1000, **kwargs):
