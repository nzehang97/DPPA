...
def drawHeatmap(scores, coords, slide_path=None, wsi_object=None, vis_level=-1, scale=32, name=None, **kwargs):
    ...
    heatmap = wsi_object.visHeatmap(scores=scores, coords=coords, vis_level=vis_level, scales=scale,name=name, **kwargs)
    return heatmap
